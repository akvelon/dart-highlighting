...
const isblEditorLightTheme = {
  ...
  'builtin': TextStyle(color: Color(0xff000080), fontWeight: FontWeight.w700),
  'literal': TextStyle(color: Color(0xff000080), fontWeight: FontWeight.w700),
  'addition': TextStyle(color: Color(0xff397300)),
  'bullet': TextStyle(color: Color(0xff397300)),
  'code': TextStyle(color: Color(0xff397300)),
  'class': TextStyle(color: Color(0xff6f1c00), fontWeight: FontWeight.w700),
  'section': TextStyle(color: Color(0xfffb2c00)),
  'title': TextStyle(color: Color(0xfffb2c00)),
  'title>.hljs-builtin': TextStyle(fontWeight: FontWeight.w400),
