...
final nginx = Mode(
    refs: {
      ...
      '~contains~1~contains~3': Mode(className: "regexp", contains: [
        BACKSLASH_ESCAPE,
      ...
      '~contains~1~contains~2': Mode(
          ...
          endsWithParent: true,
          excludeEnd: true,
          contains: [Mode(ref: '~contains~1~contains~1~contains~1')]),
      ...
      '~contains~1~contains~1': Mode(className: "string", contains: [
        BACKSLASH_ESCAPE,
        Mode(ref: '~contains~1~contains~1~contains~1')
      ], variants: [
        Mode(begin: "\"", end: "\""),
    ...
    contains: [
      HASH_COMMENT_MODE,
      Mode(beginKeywords: "upstream location", end: ";|\\{", contains: [
        HASH_COMMENT_MODE,
