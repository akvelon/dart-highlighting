  ...
  refs: {
    '~contains~1~contains~1~starts': Mode(
      ...
      contains: [
        ...
        ModeReference('~contains~1~contains~0~contains~3'),
        ModeReference('~contains~1~contains~0~contains~4'),
        ModeReference('~contains~1~contains~0~contains~5'),
        ModeReference('~contains~1~contains~0~contains~6'),
        ModeReference('~contains~1~contains~0~contains~7'),
        ModeReference('~contains~1~contains~0~contains~8'),
        ModeReference('~contains~1~contains~0~contains~8~contains~8'),
        ModeReference('~contains~1~contains~0~contains~8~contains~9'),
        ModeReference('~contains~1~contains~0~contains~8~contains~10'),
      ],
    ),
